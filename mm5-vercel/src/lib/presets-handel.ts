...
export const PRESET_PARAMETERS_HANDEL: Record<HandelPreset, GameParametersHandel> = {
  easy: {
    ...
    purchaseNegotiationThreshold: 6000,
    purchaseNegotiationDiscount: 0.08,
  ...
  medium: {
    ...
    purchaseNegotiationThreshold: 7500,
    purchaseNegotiationDiscount: 0.06,
    demandBoostNextPeriod: false,
    freeMarketAnalysisNextPeriod: false,
    noInventoryCostsNextPeriod: false,
    allowNegotiationNextPeriod: false,
  ...
  hard: {
    ...
    purchaseNegotiationThreshold: 9000,
    purchaseNegotiationDiscount: 0.05,
    demandBoostNextPeriod: false,
    freeMarketAnalysisNextPeriod: false,
    noInventoryCostsNextPeriod: false,
    allowNegotiationNextPeriod: false,
